...
import com.amazon.spapi.models.fulfillmentinbound.NonPartneredSmallParcelPackageOutput;
 ...
 */
@Schema(description = "A list of packages, including carrier, tracking number, and status information for each package.")
