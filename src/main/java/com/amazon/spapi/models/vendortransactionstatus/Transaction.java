...
package com.amazon.spapi.models.vendortransactionstatus;

import java.util.Objects;
import java.util.Arrays;
import com.amazon.spapi.models.vendortransactionstatus.ErrorList;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-08-19T18:34:38.325166+08:00[Asia/Shanghai]")
public class Transaction {
  ...
  **/
  @Schema(required = true, description = "The unique identifier returned in the 'transactionId' field in response to the post request of a specific transaction.")
