...
import com.amazon.spapi.models.fulfillmentoutbound.ReturnItem;
 ...
 */
@Schema(description = "An array of items that Amazon accepted for return. Returns empty if no items were accepted for return.")
