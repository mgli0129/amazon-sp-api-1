...
import com.amazon.spapi.models.vendorshipments.Expiry;
import com.amazon.spapi.models.vendorshipments.Money;
...
public class ItemDetails {
  ...
  **/
  @Schema(description = "The Amazon purchase order number for the shipment being confirmed. If the items in this shipment belong to multiple purchase order numbers that are in particular carton or pallet within the shipment, then provide the purchaseOrderNumber at the appropriate carton or pallet level. Formatting Notes: 8-character alpha-numeric code.")
