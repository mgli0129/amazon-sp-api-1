...
import com.amazon.spapi.model.vendordirectfulfillmentshippingv1.Address;
import com.amazon.spapi.model.vendordirectfulfillmentshippingv1.StatusUpdateDetailsShipmentSchedule;
...
public class StatusUpdateDetails {
  ...
  **/
   ...
   * @return statusCode
  **/
  @Schema(required = true, description = "Indicates the shipment status code of the package that provides transportation information for Amazon tracking systems and ultimately for the final customer.")
   ...
   * @return reasonCode
  **/
  @Schema(required = true, description = "Provides a reason code for the status of the package that will provide additional information about the transportation status.")
