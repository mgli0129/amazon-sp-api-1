...
public class Address {
  ...
  **/
   ...
   * @return city
  **/
  @Schema(required = true, description = "The city where the person, business or institution is located.")
  ...
  **/
  @Schema(required = true, description = "The state or region where person, business or institution is located.")
   ...
   * @return postalCode
  **/
  @Schema(required = true, description = "The postal code of that address. It conatins a series of letters or digits or both, sometimes including spaces or punctuation.")
