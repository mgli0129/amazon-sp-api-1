...
public class ListingsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call patchListingsItemCall(ListingsItemPatchRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call patchListingsItemValidateBeforeCall(ListingsItemPatchRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = patchListingsItemCall(body, marketplaceIds, sellerId, sku, issueLocale, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListingsItemSubmissionResponse patchListingsItem(ListingsItemPatchRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale) throws ApiException {
        ApiResponse<ListingsItemSubmissionResponse> resp = patchListingsItemWithHttpInfo(body, marketplaceIds, sellerId, sku, issueLocale);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListingsItemSubmissionResponse> patchListingsItemWithHttpInfo(ListingsItemPatchRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale) throws ApiException {
        com.squareup.okhttp.Call call = patchListingsItemValidateBeforeCall(body, marketplaceIds, sellerId, sku, issueLocale, null, null);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call patchListingsItemAsync(ListingsItemPatchRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ApiCallback<ListingsItemSubmissionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = patchListingsItemValidateBeforeCall(body, marketplaceIds, sellerId, sku, issueLocale, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call putListingsItemCall(ListingsItemPutRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call putListingsItemValidateBeforeCall(ListingsItemPutRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = putListingsItemCall(body, marketplaceIds, sellerId, sku, issueLocale, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListingsItemSubmissionResponse putListingsItem(ListingsItemPutRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale) throws ApiException {
        ApiResponse<ListingsItemSubmissionResponse> resp = putListingsItemWithHttpInfo(body, marketplaceIds, sellerId, sku, issueLocale);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListingsItemSubmissionResponse> putListingsItemWithHttpInfo(ListingsItemPutRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale) throws ApiException {
        com.squareup.okhttp.Call call = putListingsItemValidateBeforeCall(body, marketplaceIds, sellerId, sku, issueLocale, null, null);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call putListingsItemAsync(ListingsItemPutRequest body, List<String> marketplaceIds, String sellerId, String sku, String issueLocale, final ApiCallback<ListingsItemSubmissionResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = putListingsItemValidateBeforeCall(body, marketplaceIds, sellerId, sku, issueLocale, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListingsItemSubmissionResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
