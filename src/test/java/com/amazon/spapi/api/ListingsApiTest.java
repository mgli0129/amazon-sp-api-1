...
public class ListingsApiTest {
    ...
    public void patchListingsItemTest() throws ApiException {
        ...
        String sku = null;
        String issueLocale = null;
        ListingsItemSubmissionResponse response = api.patchListingsItem(body, marketplaceIds, sellerId, sku, issueLocale);
    ...
    public void putListingsItemTest() throws ApiException {
        ...
        String sku = null;
        String issueLocale = null;
        ListingsItemSubmissionResponse response = api.putListingsItem(body, marketplaceIds, sellerId, sku, issueLocale);
